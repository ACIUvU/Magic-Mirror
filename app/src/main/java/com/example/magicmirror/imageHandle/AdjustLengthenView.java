package com.example.magicmirror.imageHandle;
...
public class AdjustLengthenView extends View {
    ...
    public AdjustLengthenView(Context context) {
        super(context);
        init();
    }

    public AdjustLengthenView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AdjustLengthenView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
