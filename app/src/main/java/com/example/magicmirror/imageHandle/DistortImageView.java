...
public class DistortImageView extends View{
    ...
    public DistortImageView(Context context) {
        super(context);
        init();
    }

    public DistortImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DistortImageView(Context context, AttributeSet attrs, int defStyleAttr) {
